...
public class TacheGroupActivityD extends AppCompatActivity {
    ...
    private void aprop(){
        ...
        Intent intent = new Intent(TacheGroupActivityD.this, AproposActivity.class);
        startActivity(intent);
    }

    private void help(){

        Intent intent = new Intent(TacheGroupActivityD.this, HelpActivity.class);
        startActivity(intent);
    }

    private void paramBtn(){

        Intent intent = new Intent(TacheGroupActivityD.this, ParamActivity.class);
        startActivity(intent);
    }

    private void logoutBtn(){
        Intent intent = new Intent(TacheGroupActivityD.this, LoginActivity.class);
        startActivity(intent);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Collections.sort(tabTache, Tache.TacheGroupeComparator);
        ...
        for (int i = 0; i < N; i++) {
            ...
            rowEtat.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intentAff = new Intent(TacheGroupActivityD.this, AffichageTacheActivity.class);
                    String strName = null;
            ...
            public void onItemSelected(AdapterView<?> arg0, View view,
                ...
                switch(position){
                    case 0:
                        ...
                        break;
                    case 1:
                        newI = new Intent(TacheGroupActivityD.this, TacheGroupActivityC.class);
                        startAct = true;
                        break;
                    case 2:
                        newI = new Intent(TacheGroupActivityD.this, TacheGroupActivity.class);
                        startAct = true;
                        break;

                    case 3:
                        newI = new Intent(TacheGroupActivityD.this, TacheGroupActivityB.class);
                        startAct = true;
                        break;
    ...
    {
        Intent intent = new Intent(TacheGroupActivityD.this, AjoutActivity.class);
        startActivity(intent);
    }

    public void intent_groupe(View view)
    {
        Intent intent = new Intent(TacheGroupActivityD.this, GroupesActivity.class);
        startActivity(intent);
    }

    public void intent_tache(View view)
    {
        Intent intent = new Intent(TacheGroupActivityD.this, MainActivity.class);
        startActivity(intent);
    }
